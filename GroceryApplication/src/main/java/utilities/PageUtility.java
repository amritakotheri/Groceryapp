...
public class PageUtility {
	...
	public void javaScriptExecuterClick(WebDriver driver, WebElement webelementname) {
		JavascriptExecutor js = (JavascriptExecutor) driver;
	...
	public void fullScroll(WebDriver driver) {
		JavascriptExecutor js = (JavascriptExecutor) driver;
		js.executeScript("window.scrollBy(0,document.body.scrollHeight)", "");// calculate the height and scroll from
																				// top to the page end
	}
}
